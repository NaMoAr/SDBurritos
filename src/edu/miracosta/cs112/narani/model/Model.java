...
public class Model {
	...
	private static final String CSV_FILE = "SDBurritos.csv";//first time
	public static final String BINARY_FILE = "SDBurritos.dat";//then
	...
	public static boolean writeDataToBinaryFile(ObservableList<Burrito> allBurritosList) {
		...
		try {
			...
			//make another temp array
			Burrito[] tempArray = new Burrito[allBurritosList.size()];
			//fill array with all elements in the list
