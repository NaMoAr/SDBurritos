...
public class MainScene extends Scene {
    ...
    public MainScene() {
        ...
        burritosLV.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Burrito>() {
            @Override
            public void changed(ObservableValue<? extends Burrito> observable, Burrito oldValue, Burrito newValue) {
                modifyBurritoButton.setDisable(newValue == null);
                if(newValue != null)
                    selectedBurrito = newValue;
            }
        });
...
if(selectedBurrito == null)
    return;
ViewNavigator.loadScene("Modify Burrito", new ModifyScene(this,selectedBurrito ));
        updateDisplay();
    }
    ...
    private void addBurrito() {
        ...
        ViewNavigator.loadScene("Add Burito" , new AddScene(this));
        //TODO: Update the display when done.
updateDisplay();
    ...
    private void updateDisplay()
    {
        ...
        locationsCB.setItems(controller.getDistinctLocations());
        //TODO: Set the items of the neighborhoods combo box to get the distinct neighborhoods(again)
        locationsCB.setItems(controller.getDistinctNeighborhoods());
