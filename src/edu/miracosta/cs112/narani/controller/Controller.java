package edu.miracosta.cs112.narani.controller;

import edu.miracosta.cs112.narani.model.Model;
...
if(Model.binaryFileHasData())
	theInstance.mAllBurritosList = Model.populateListFromBinaryFile();
else
